    ...
    override func layoutSubviews() {
        ...
        case .notification:
            ...
            if let detail = detailTextLabel.text as NSString? {
                ...
                detailTextLabel.frame.size.height = detail.boundingRect(with: CGSize(width: detailTextLabel.frame.width, height: CGFloat.greatestFiniteMagnitude), options: NSStringDrawingOptions.usesLineFragmentOrigin, attributes: [kCTFontAttributeName as NSAttributedStringKey : detailTextLabel.font], context: nil).size.height
            }
...
extension HUDContentView{
    ...
    @objc func keyboardWillChangeFrameNotification() {
